...
export default function OutputSection({
  ...
  const processMessageContent = (role: string, content: string) => {
    // Return the full content without cutting off any words
    return content;
  };
    ...
    >
      ...
      {(() => {
        ...
        for (let i = 0; i < messages.length; i++) {
              ...
              renderedMessages.push(
                ...
                >
                  <div className="bg-blue-50 border-2 border-blue-200 text-blue-800 px-4 py-3 rounded-2xl max-w-4xl">
                    <div className="p-4">
                      <h3 className="text-center font-semibold mb-2 text-md">
                        Summary
                      </h3>
                      <p
                        className="whitespace-pre-line text-black"
                        dangerouslySetInnerHTML={{
                          __html: toBulletPoints(summaryContent),
                        }}
                      ></p>
                    </div>
                  </div>
          ...
          renderedMessages.push(
            <div
              key={`normal-${i}`}
              className={`flex items-start gap-4 animate__animated animate__fadeInUp transition-all duration-1000 ease-in-out ${
      ...
      {loading && typingAgent === "jane" && (
        <div className="flex justify-end items-start gap-4 animate-pulse">
          <div className="bg-gray-200 p-3 rounded-lg max-w-2xl">
